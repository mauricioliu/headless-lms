...
on Plate.js. Some people love TipTap, some people has existing SCORM frontends. The [Editor Contract](packages/editor-contract)
is what you'll use to implement your frontend.
